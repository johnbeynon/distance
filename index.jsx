    ...
    for (const postcode of postcodeList) {
      try {
        const response = await fetch(
          `https://api.openrouteservice.org/v2/directions/driving-car?api_key=5b3ce3597851110001cf6248a3a7c0fcf8e64d0a8b0c5c0e6c5c5c5c&start=${encodeURIComponent(postcode)},UK&end=GU1 4RR,UK`
        );
